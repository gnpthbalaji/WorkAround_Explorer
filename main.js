...
function updateResults() {
  ...
  const averageSalaryByRole = formatCurrency(getAverageSalaryByRole(role));
  const averageSalaryByCompany = formatCurrency(getAverageSalaryByCompany(company));
  const salary = formatCurrency(getSalaryAtCompany(role, company));
  const industryAverageSalary = formatCurrency(getIndustryAverageSalary());
